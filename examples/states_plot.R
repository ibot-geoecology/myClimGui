...
states <- tribble(
        ...
        "A1E05"    ,    "Thermo_1",   "error",  lubridate::ymd_hm("2020-11-01 0:00"), lubridate::ymd_hm("2020-11-01 23:30"),
        "A1E05"    ,    "Thermo_1",   "error", lubridate::ymd_hm("2020-11-03 10:00"), lubridate::ymd_hm("2020-11-03 12:00"),
        "A1E05"    ,    "Thermo_1",    "test", lubridate::ymd_hm("2020-11-01 12:00"),  lubridate::ymd_hm("2020-11-02 5:00"),
)
